...
<?php
$allfollowers = mysqli_query($link, "SELECT * FROM mf_follow WHERE user ='$sid' AND admin IS NOT NULL");
...
echo '
    <div class="flwr-user-card">
        <div class="user-dp">
		<a href="u/'.$following.'"><img src="'.$dp.'" /></a>
        </div>
         <div class="as-user-name flwr-user-card-info">                    
