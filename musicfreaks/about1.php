...
<center>
 ...
 <font face="Arial" style="font-weight:normal;  color:#9C9E9E; font-size:50px;
	position:none; 
	text-shadow: 0px 0.5px #959595;">About Musicfreaks.in</font><div class="underline"></div></center>
  <div class="about-site">
  
<h1 style="margin-top:50px;"><font face="Circular,Helvetica,Arial,sans-serif" style="font-weight: 400; font-size:30px; color:#333;">About</font></h1>
<h2 style="margin-top:22px; font-size:23px;"><font face="Circular,Helvetica,Arial,sans-serif" style="font-weight: 400; color:#656565;"> Here at musicfreaks.in we provide you the collection of thousands of songs – from old 80s, 90s to the latest hits.<br/>Just hit on play to stream anything you like. 
</font></h2>
<ul id="about-list">
<li> <font style="font-weight:600;">Explore –</font> Explore thousands of songs and your favorite artists.</li>
<li> <font style="font-weight:600;">Listen anywhere –</font> We provide you an environment that can be created according to your need(computer, mobile, tablet). </li>
<li> <font style="font-weight:600;">Fast & Smooth –</font> We're more faster than others, just to provide you a smooth experience.</li>
</ul>
<h1 style="margin-top:55px;"><font face="Circular,Helvetica,Arial,sans-serif" style="font-weight: 400; font-size:30px; color:#333;">Our Plans</font></h1><!--<div class="underline" style="margin-left:15px; width:170px;"></div>-->
<h2></h2>
</form>
</div>
</div>
